...
function today() {
  ...
  switch (day) {
    ...
    case 13:
      ...
      break;
    case 14:
      document.getElementById("a14").className = "aitvaras today";
      break;
    case 15:
    ...
    case 20:
      ...
      break;
    case 21:
      document.getElementById("a21").className = "aitvaras today";
      break;
    case 22:
      document.getElementById("a22").className = "free today";
      break;
    case 23:
      document.getElementById("a23").className = "lygaE today";
      break;
    case 24:
    ...
    case 27:
      ...
      break;
    case 28:
      document.getElementById("a28").className = "aitvaras today";
      break;
    case 29:
    ...
    case 101:
      ...
      break;
    case 102:
      document.getElementById("b2").className = "lygaE today";
      break;
    case 103:
      document.getElementById("b3").className = "free today";
      break;
    case 104:
      document.getElementById("b4").className = "aitvaras today";
      break;
    case 105:
    ...
    case 108:
      ...
      break;
    case 109:
      document.getElementById("b9").className = "lygaE today";
      break;
    case 110:
      document.getElementById("b10").className = "free today";
      break;
    case 111:
      document.getElementById("b11").className = "aitvaras today";
      break;
    case 112:
      document.getElementById("b12").className = "free today";
      break;
    case 113:
      document.getElementById("b13").className = "lygaE today";
      break;
    case 114:
    ...
    case 124:
      ...
      break;
    case 125:
      document.getElementById("b25").className = "mix today";
      break;
    case 126:
      document.getElementById("b26").className = "free today";
      break;
    case 127:
      document.getElementById("b27").className = "lygaE today";
      break;
    case 128:
...
db.collection("a3").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA3++;
      document.getElementById("countA3").innerHTML = countA3;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a4").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA4++;
      document.getElementById("countA4").innerHTML = countA4;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a5").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA5++;
      document.getElementById("countA5").innerHTML = countA5;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a6").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA6++;
      document.getElementById("countA6").innerHTML = countA6;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a7").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA7++;
      document.getElementById("countA7").innerHTML = countA7;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a8").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA8++;
      document.getElementById("countA8").innerHTML = countA8;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a9").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA9++;
      document.getElementById("countA9").innerHTML = countA9;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a10").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA10++;
      document.getElementById("countA10").innerHTML = countA10;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a11").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA11++;
      document.getElementById("countA11").innerHTML = countA11;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a12").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA12++;
      document.getElementById("countA12").innerHTML = countA12;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a13").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA13++;
      document.getElementById("countA13").innerHTML = countA13;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a14").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA14++;
      document.getElementById("countA14").innerHTML = countA14;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a15").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA15++;
      document.getElementById("countA15").innerHTML = countA15;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a16").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA16++;
      document.getElementById("countA16").innerHTML = countA16;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a17").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA17++;
      document.getElementById("countA17").innerHTML = countA17;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a18").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA18++;
      document.getElementById("countA18").innerHTML = countA18;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a19").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA19++;
      document.getElementById("countA19").innerHTML = countA19;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a20").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA20++;
      document.getElementById("countA20").innerHTML = countA20;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a21").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA21++;
      document.getElementById("countA21").innerHTML = countA21;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a22").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA22++;
      document.getElementById("countA22").innerHTML = countA22;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a23").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA23++;
      document.getElementById("countA23").innerHTML = countA23;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a24").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA24++;
      document.getElementById("countA24").innerHTML = countA24;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a25").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA25++;
      document.getElementById("countA25").innerHTML = countA25;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a26").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA26++;
      document.getElementById("countA26").innerHTML = countA26;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a27").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA27++;
      document.getElementById("countA27").innerHTML = countA;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
      ...
      plansA27.classList.remove("addedPlans");
      countA27--;
      document.getElementById("countA27").innerHTML = countA27;
    }
    if (change.type === "modified") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a28").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA28++;
      document.getElementById("countA28").innerHTML = countA28;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a29").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA29++;
      document.getElementById("countA29").innerHTML = countA29;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a30").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA30++;
      document.getElementById("countA30").innerHTML = countA30;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("a31").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countA31++;
      document.getElementById("countA31").innerHTML = countA31;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b1").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB1++;
      document.getElementById("countB1").innerHTML = countB1;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b2").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB2++;
      document.getElementById("countB2").innerHTML = countB2;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b3").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB3++;
      document.getElementById("countB3").innerHTML = countB3;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b4").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB4++;
      document.getElementById("countB4").innerHTML = countB4;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b5").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB5++;
      document.getElementById("countB5").innerHTML = countB5;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b6").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB6++;
      document.getElementById("countB6").innerHTML = countB6;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b7").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB7++;
      document.getElementById("countB7").innerHTML = countB7;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b9").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB9++;
      document.getElementById("countB9").innerHTML = countB9;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b10").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB10++;
      document.getElementById("countB10").innerHTML = countB10;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b11").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB11++;
      document.getElementById("countB11").innerHTML = countB11;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b12").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB12++;
      document.getElementById("countB12").innerHTML = countB12;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b13").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB13++;
      document.getElementById("countB13").innerHTML = countB13;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b14").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB14++;
      document.getElementById("countB14").innerHTML = countB14;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b15").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB15++;
      document.getElementById("countB15").innerHTML = countB15;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b16").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB16++;
      document.getElementById("countB16").innerHTML = countB16;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b17").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB17++;
      document.getElementById("countB17").innerHTML = countB17;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b18").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB18++;
      document.getElementById("countB18").innerHTML = countB18;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b19").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB19++;
      document.getElementById("countB19").innerHTML = countB19;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b20").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB20++;
      document.getElementById("countB20").innerHTML = countB20;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b21").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB21++;
      document.getElementById("countB21").innerHTML = countB21;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b22").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB22++;
      document.getElementById("countB22").innerHTML = countB22;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b23").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB23++;
      document.getElementById("countB23").innerHTML = countB23;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b24").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB24++;
      document.getElementById("countB24").innerHTML = countB24;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b25").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB25++;
      document.getElementById("countB25").innerHTML = countB25;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b26").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB26++;
      document.getElementById("countB26").innerHTML = countB26;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b27").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB27++;
      document.getElementById("countB27").innerHTML = countB27;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b28").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB28++;
      document.getElementById("countB28").innerHTML = countB28;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b29").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB29++;
      document.getElementById("countB29").innerHTML = countB29;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b30").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB30++;
      document.getElementById("countB30").innerHTML = countB30;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
...
db.collection("b31").onSnapshot((snapshot) => {
  snapshot.docChanges().forEach((change) => {
    if (change.type === "added") {
      ...
      countB31++;
      document.getElementById("countB31").innerHTML = countB31;
    }
    if (change.type === "removed") {
      let tr = document.querySelector(`[data-id='${change.doc.id}']`);
      let tbody = tr.parentElement;
